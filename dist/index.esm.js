...
function ECNav(props) {
  ...
  var _useState7 = useState(true),
      ...
      withShadow = _useState8[0],
      setWithShadow = _useState8[1];

  var _useState9 = useState(null),
      _useState10 = _slicedToArray(_useState9, 2),
      onboard = _useState10[0],
      setOnboard = _useState10[1];
  ...
  useEffect(function () {
    if (projectBaseUrl && navRef) {
      ...
      var navItems = navRef.current.children;
  ...
  return /*#__PURE__*/React.createElement("nav", {
    className: "navbar navbar-expand-lg fixed-top ".concat(darkMode ? 'navbar-dark' : 'navbar-light', " ").concat(withShadow ? '' : 'no-shadow', " ")
  ...
  }, "ETHER CARDS")), /*#__PURE__*/React.createElement("ul", {
    ...
    className: "dropdown-toggle"
  }, "DYNAMIC NFTS")), /*#__PURE__*/React.createElement("ul", {
    className: "dropdown-menu",
    "aria-labelledby": "navbarDropdown"
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(ECLink, {
    className: "dropdown-item",
...
var ECFooter = function ECFooter() {
  ...
  }, "\xA9"), " 2021 All Rights Reserved"), /*#__PURE__*/React.createElement("img", {
    src: img,
    style: {
      height: '35px',
      opacity: '0.6'
...
export { ECAddress, ECFooter, ECNav };
